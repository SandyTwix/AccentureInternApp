...
namespace Accenture
{
    public partial class Postavki : Form
    {
        ...
        public static string queryText = "SELECT * FROM Поставки";// запрос на все столбцы таблицы Города
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                Caption = "Отчет по таблице \"Поставки\"",
                Visible = true
            };
            ...
            foreach (Section section in wordTable.Application.ActiveDocument.Sections)
            {
                ...
                headerRange.Text = "Отчет по таблице \"Поставки\"";
            }
