...
namespace Accenture
{
    public partial class Modeli : Form
    {
        ...
        public static string queryText = "SELECT * FROM Модели";// запрос на все столбцы таблицы Города
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                Caption = "Отчет по таблице \"Модели\"",
                Visible = true
            };
            ...
            foreach (Section section in wordTable.Application.ActiveDocument.Sections)
            {
                ...
                headerRange.Text = "Отчет по таблице \"Модели\"";
            }
