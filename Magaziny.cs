...
namespace Accenture
{
    public partial class Magaziny : Form
    {
        ...
        public static string queryText = "SELECT * FROM Магазины";// запрос на все столбцы таблицы Магазины
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                Caption = "Отчет по таблице \"Магазины\"",
                Visible = true
            };
            ...
            foreach (Section section in wordTable.Application.ActiveDocument.Sections)
            {
                ...
                headerRange.Text = "Отчет по таблице \"Магазины\"";
            }
