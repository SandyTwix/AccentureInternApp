...
namespace Accenture
{
    public partial class СкладЗавода : Form
    {
        ...
        public static string queryText = "SELECT * FROM СкладЗавода";// запрос на все столбцы таблицы Города
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                Caption = "Отчет по таблице \"Склад завода\"",
                Visible = true
            };
            ...
            foreach (Section section in wordTable.Application.ActiveDocument.Sections)
            {
                ...
                headerRange.Text = "Отчет по таблице \"Склад завода\"";
            }
            ...
            for (int i = 0; i < columnCount; i++)
            {
                ...
                wordCellRange.Text = Convert.ToString(dataGridView1.Columns[i].HeaderText) + "\t";
            }
