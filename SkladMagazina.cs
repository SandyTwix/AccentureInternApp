...
namespace Accenture
{
    public partial class SkladMagazina : Form
    {
        ...
        public static string queryText = "SELECT * FROM СкладМагазина";// запрос на все столбцы таблицы Города
        public static DataSet dataSet;
        public static OleDbDataAdapter adapter;

        public SkladMagazina()
        {
            InitializeComponent();
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                Caption = "Отчет по таблице \"Склад магазина\"",
                Visible = true
            };
            ...
            foreach (Section section in wordTable.Application.ActiveDocument.Sections)
            {
                ...
                headerRange.Text = "Отчет по таблице \"Склад магазина\"";
            }
